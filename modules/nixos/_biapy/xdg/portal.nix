...
let
  ...
  cfg = config.biapy.xdg.portal;
in
{
  options.biapy.xdg.portal.enable = mkEnableOption "XDG portal";
  ...
  config = mkIf cfg.enable {
    xdg.portal = {
      ...
      # Enable XDG Portal wayland-root integration
    ...
    environment.pathsToLink = optionals config.home-manager.useUserPackages [
